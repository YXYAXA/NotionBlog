const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-08-16', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.yyai.tech' },
    { title: '限时注册免费使用各大AI', url: 'https://www.yuychat.cn' }
  ],
  ...
  HEO_HERO_TITLE_5: '轻松白嫖，尽在羊语BLOG',
