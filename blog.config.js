...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.yyai.tech', // 网站地址
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || np2xuy9sgz, // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
